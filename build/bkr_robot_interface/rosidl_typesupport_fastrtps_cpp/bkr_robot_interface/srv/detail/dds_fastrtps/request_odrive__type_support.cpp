...
#include "bkr_robot_interface/srv/detail/request_odrive__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bkr_robot_interface::srv::RequestOdrive_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bkr_robot_interface::srv::RequestOdrive_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bkr_robot_interface::srv::RequestOdrive_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RequestOdrive_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bkr_robot_interface::srv::RequestOdrive_Request *>(
...
static size_t _RequestOdrive_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RequestOdrive_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RequestOdrive_Request__callbacks = {
...
static rosidl_message_type_support_t _RequestOdrive_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RequestOdrive_Request__callbacks,
...
{
  return &bkr_robot_interface::srv::typesupport_fastrtps_cpp::_RequestOdrive_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = bkr_robot_interface::srv::RequestOdrive_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bkr_robot_interface::srv::RequestOdrive_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<bkr_robot_interface::srv::RequestOdrive_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RequestOdrive_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bkr_robot_interface::srv::RequestOdrive_Response *>(
...
static size_t _RequestOdrive_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RequestOdrive_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RequestOdrive_Response__callbacks = {
  "bkr_robot_interface::srv",
...
static rosidl_message_type_support_t _RequestOdrive_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RequestOdrive_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &bkr_robot_interface::srv::typesupport_fastrtps_cpp::_RequestOdrive_Response__handle;
}
...
static service_type_support_callbacks_t _RequestOdrive__callbacks = {
  "bkr_robot_interface::srv",
  "RequestOdrive",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bkr_robot_interface, srv, RequestOdrive_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bkr_robot_interface, srv, RequestOdrive_Response)(),
...
static rosidl_service_type_support_t _RequestOdrive__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RequestOdrive__callbacks,
...
{
  return &bkr_robot_interface::srv::typesupport_fastrtps_cpp::_RequestOdrive__handle;
}
