...
static const _LinearMove_Request_type_support_symbol_names_t _LinearMove_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bkr_robot_interface, srv, LinearMove_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bkr_robot_interface, srv, LinearMove_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bkr_robot_interface, srv, LinearMove_Request)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_c::LinearMove_Request_message_type_support_handle;
}
...
static const _LinearMove_Response_type_support_symbol_names_t _LinearMove_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bkr_robot_interface, srv, LinearMove_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bkr_robot_interface, srv, LinearMove_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bkr_robot_interface, srv, LinearMove_Response)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_c::LinearMove_Response_message_type_support_handle;
}
...
static const _LinearMove_type_support_symbol_names_t _LinearMove_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bkr_robot_interface, srv, LinearMove)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bkr_robot_interface, srv, LinearMove)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bkr_robot_interface, srv, LinearMove)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_c::LinearMove_service_type_support_handle;
}
