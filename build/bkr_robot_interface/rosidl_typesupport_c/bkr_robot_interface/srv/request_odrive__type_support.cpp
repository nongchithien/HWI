...
static const _RequestOdrive_Request_type_support_symbol_names_t _RequestOdrive_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bkr_robot_interface, srv, RequestOdrive_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bkr_robot_interface, srv, RequestOdrive_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bkr_robot_interface, srv, RequestOdrive_Request)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_c::RequestOdrive_Request_message_type_support_handle;
}
...
static const _RequestOdrive_Response_type_support_symbol_names_t _RequestOdrive_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bkr_robot_interface, srv, RequestOdrive_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bkr_robot_interface, srv, RequestOdrive_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bkr_robot_interface, srv, RequestOdrive_Response)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_c::RequestOdrive_Response_message_type_support_handle;
}
...
static const _RequestOdrive_type_support_symbol_names_t _RequestOdrive_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bkr_robot_interface, srv, RequestOdrive)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bkr_robot_interface, srv, RequestOdrive)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bkr_robot_interface, srv, RequestOdrive)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_c::RequestOdrive_service_type_support_handle;
}
