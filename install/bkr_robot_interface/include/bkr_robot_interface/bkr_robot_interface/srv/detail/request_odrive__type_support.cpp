...
{
  new (message_memory) bkr_robot_interface::srv::RequestOdrive_Request(_init);
}

void RequestOdrive_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bkr_robot_interface::srv::RequestOdrive_Request *>(message_memory);
  typed_message->~RequestOdrive_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RequestOdrive_Request_message_member_array[3] = {
  {
    "action",  // name
    ...
    offsetof(bkr_robot_interface::srv::RequestOdrive_Request, action),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bkr_robot_interface::srv::RequestOdrive_Request, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bkr_robot_interface::srv::RequestOdrive_Request, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RequestOdrive_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(bkr_robot_interface::srv::RequestOdrive_Request),
...
{
  return &::bkr_robot_interface::srv::rosidl_typesupport_introspection_cpp::RequestOdrive_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bkr_robot_interface, srv, RequestOdrive_Request)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_introspection_cpp::RequestOdrive_Request_message_type_support_handle;
}
...
void RequestOdrive_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) bkr_robot_interface::srv::RequestOdrive_Response(_init);
}

void RequestOdrive_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bkr_robot_interface::srv::RequestOdrive_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RequestOdrive_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bkr_robot_interface::srv::RequestOdrive_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RequestOdrive_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(bkr_robot_interface::srv::RequestOdrive_Response),
...
{
  return &::bkr_robot_interface::srv::rosidl_typesupport_introspection_cpp::RequestOdrive_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bkr_robot_interface, srv, RequestOdrive_Response)() {
  return &::bkr_robot_interface::srv::rosidl_typesupport_introspection_cpp::RequestOdrive_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers RequestOdrive_service_members = {
  ...
  // see get_service_type_support_handle<bkr_robot_interface::srv::RequestOdrive>()
...
get_service_type_support_handle<bkr_robot_interface::srv::RequestOdrive>()
{
  ...
  auto service_type_support =
    &::bkr_robot_interface::srv::rosidl_typesupport_introspection_cpp::RequestOdrive_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bkr_robot_interface, srv, RequestOdrive)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<bkr_robot_interface::srv::RequestOdrive>();
}
